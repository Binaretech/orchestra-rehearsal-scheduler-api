...
CREATE TABLE instruments (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_instruments_sections FOREIGN KEY (section_id) REFERENCES sections(section_id)
);
...
CREATE TABLE user_instruments (
    ...
    CONSTRAINT fk_user_instruments_instruments FOREIGN KEY (instrument_id) REFERENCES instruments(id),
    CONSTRAINT fk_user_instruments_users FOREIGN KEY (user_id) REFERENCES users(id)
);
...
CREATE TABLE rehearsals (
    ...
    CONSTRAINT fk_rehearsals_concerts FOREIGN KEY (concert_id) REFERENCES concerts(id),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE rehearsal_users (
    ...
    CONSTRAINT fk_rehearsal_users_rehearsals FOREIGN KEY (rehearsal_id) REFERENCES rehearsals(id),
    CONSTRAINT fk_rehearsal_users_users FOREIGN KEY (user_id) REFERENCES users(id)
);
